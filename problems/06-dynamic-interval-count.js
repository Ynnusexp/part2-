...
***********************************************************************/
//INPUT: callback, delay (ms), optional amount
/*OUTPUT:
  setInterval(cb, delay)
  if amount, clear after cb is called amount number of times
  if no amount, return timeout object for interval
    never timeout, keep printing
    amount === undefined
*/
//BASE: amount === 0      -> clearInterval(interval obj)
//RECURSE: amount > 0     -> dynamicIntervalCount()
//STEP: amount--
function dynamicIntervalCount(cb, delay, amount) {
  ...
  delay);
  if (amount === undefined) return intervalObj;
}
